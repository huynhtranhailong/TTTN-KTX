...
module.exports = function(Chart) {
	...
	helpers.extend(Chart.Controller.prototype, /** @lends Chart.Controller */ {
		 ...
		 * @description Called before all datasets are updated. If a plugins returns false,
...
module.exports = function(Chart) {
	...
	Chart.plugins = {
		...
		/**
		 * Returns all registered plugins intances.
		 ...
		 * method immediately returns as soon as a plugins explicitly returns false. The
		 * returned value can be used, for instance, to interrupt the current action.
		 * @param {String} extension the name of the plugins method to call (e.g. 'beforeUpdate').
